<template>
  <div class="enchanted-item" :style="{ width: width + 'px', height: height + 'px' }">
    <img :src="resolvedItemImage" alt="Item" class="item-image">
...
export default {
  ...
  data() {
    return {
      ...
      resolvedItemImage: '',
      resolvedGlintImage: new URL('/Main/assets/UI/enchanted_glint_item.png', import.meta.url).href,
    };
  },
  computed: {
    glintStyle() {
      ...
      return {
        backgroundImage: `url(${this.resolvedGlintImage})`,
  ...
  methods: {
    resolveImages() {
      this.resolvedItemImage = new URL(`/Main/assets/${this.itemImage}.png`, import.meta.url).href;

      const itemImg = new Image();
      itemImg.src = this.resolvedItemImage;
      itemImg.onload = () => {
        this.createMask();
        this.startAnimation();
      };
      ...
      glintImg.src = this.resolvedGlintImage;
    },
    createMask() {
